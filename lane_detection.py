...
# defalt video number, if you want to process the "fog_lane.mp4", change video_index to 0 or 1
video_index = 0
...
def project_lanelines(binary_warped, orig_img, left_fit, right_fit, dst_mask, src_mask):
    ...
    road = warped_inv   #main road file
    started = 1
...
if __name__ == '__main__':
    ...
    if video_index == 0:
        cap = cv2.VideoCapture('sunny_lane.mp4')
    else:
        cap = cv2.VideoCapture('fog_lane.mp4')
